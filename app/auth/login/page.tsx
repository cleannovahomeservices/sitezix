  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="orb orb-1 animate-d1" />
      ...
      <div className="relative w-full max-w-sm">
        ...
        <h1 className="text-[26px] font-semibold tracking-tight text-center mb-2">Welcome back</h1>
        <p className="text-sm text-white/50 text-center mb-7">Sign in to continue building</p>
        ...
        <p className="text-center text-[12.5px] text-white/50 mt-6">
          ...
          <Link href="/auth/register" className="text-[#a78bfa] hover:text-[#c4b5fd] font-medium">Create one</Link>
        </p>
      </div>
    </main>
  );
